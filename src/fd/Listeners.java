...
public class Listeners implements ITestListener, ISuiteListener, IInvokedMethodListener {
    ...
    public void onFinish(ITestContext context) {
    	final String HTML = "C:\\Test\\FrenzyDashboard\\testng-xslt\\Suite1.html";
        final String CSS = "C:\\Test\\FrenzyDashboard\\testng-xslt\\style.css";
        ...
        //Cambio de colores
         ...
         try {
            ChartUtilities.saveChartAsJPEG(new File("C:\\Test\\FrenzyDashboard\\reporte\\grafica.jpg"), piechart, 525, 390);
        } catch (IOException e) {
            ...
            try {
                writer = PdfWriter.getInstance(document, new FileOutputStream("C:\\Test\\FrenzyDashboard\\reporte\\reportefrenzy.pdf"));
              ...
              Image cabecera = null;
            try {
                img = Image.getInstance("C:\\Test\\FrenzyDashboard\\reporte\\grafica.jpg");
                cabecera = Image.getInstance("C:\\Test\\FrenzyDashboard\\reporte\\img\\cabecera.png");
